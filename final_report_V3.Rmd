---
title: "Churn Classifier for ABC Wireless - Final Report"
...
1. *Sree Ananth Kumar Seethamraju:* contribution includes discussion about the project, writing code, generating report, preparing the presentation, editing and review of the entire process.

2. *Eyob Tadele:* contribution includes discussion about the project, writing code, generating report, preparing the presentation, editing and review of the entire process.

3. *Munerah AlFayez:* participated in the discussion.

4. *Zade Al-Shayeb:* participated in the discussion.

5. *Vamshee Deepak:* participated in the discussion.
...
## 2.1. Feel of the data

We will first get a feel for our data set by getting a summary of the dataframe `churn_df`.

```{r}
churn_df <- read.csv("C:\\Users\\Ananth\\OneDrive\\Desktop\\MSBA Kent\\Fall 2021\\Business Analytics\\Assignment\\churn_train.csv", na.strings = c("", "NA"))
...
## 2.2. Negative value observation 
...
## 2.3. Other Missing Values in data 
...
##  2.4. Preliminary Data Cleaning

### 2.4.1. Turning Negatives into Positives
...
##  2.5. Concluding The Exploration
...
### 2.7.1. Stepwise Regression using kNN Imputed Data
...
### 2.7.2. Stepwise Regression using Randomforest Imputed Data
...
## 3.3. Predicting & Evaluating Accuracy
...
### 3.3.1. Evaluating The Accuracy of `modelRF`
...
### 3.3.2. Evaluating The Accuracy of `modelKNN`
...
### 3.3.3. Evaluating The Winining Model
...
```{r}
load("C:\\Users\\Ananth\\OneDrive\\Desktop\\MSBA Kent\\Fall 2021\\Business Analytics\\Assignment\\Customers_To_Predict.Rdata")
```

## 4.1. Making The Prediction
```{r}
...
# 5. Insights from Prediction

## 5.1. Churn Rate per State
...
## 5.2. How Predictors Affect Churn

### 5.2.1. Correlation of Numeric Predictors
...
### 5.2.2. How Number of Service Calls Affect Churn
...
### 5.2.3. How Total Day Calls and Total Day Charges Affect Churn
...
# 5.2.4. How Total International Calls and Total International Charges Affect Churn
...
We focused only on the numerical variables `total_intl_charge`, `total_intl_calls`, `total_eve_minutes`, `total_eve_charge`, and the categorical variable `international_plan`, when discussing their affect on `churn`; This is due to time constraint, their sign/size of their coefficients, and statistical significance.
